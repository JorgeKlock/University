		...
		if (opc == 1)
		{
			...
			case 2:
				...
				case 0:
					...
					//mal ajuste g.generarGraficaMEDIO("burbuja", 2);
					break;
				case 1:
					g.generarGraficaMEDIO("insercion", 3);
					//g.generarGraficaMEDIO("insercion", 1);
					break;
				case 2:
					g.generarGraficaMEDIO("seleccion", 3);
					//g.generarGraficaMEDIO("seleccion", 4);
					break;
				case 3:
				...
				case 4:
					...
					//g.generarGraficaMEDIO("quicksort", 1);
					break;
				case 5:
					g.generarGraficaMEDIO("heapsort", 2);
					//g.generarGraficaMEDIO("heapsort", 0);
					break;
				default:
					break;
				}
		...
		else
		{
			...
			case 2:
			{
				...
				case 0:
					...
					//g.generarGraficaMEDIO("floyd", 6);
					break;
				case 1:
					g.generarGraficaMEDIO("fibonacci", 5);
					break;
				case 2:
					g.generarGraficaMEDIO("hanoi", 6);
					//g.generarGraficaMEDIO("hanoi", 4);
				default:
					break;
				}
				system("pause");
