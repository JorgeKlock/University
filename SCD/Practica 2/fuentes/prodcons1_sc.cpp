...
//1-CONVERTIR A FIFOOOOOOOOOOOOOOOOOOOOOOOO (en el pc de casa)
//2-CRREAR UN ARCHIVO NUEVO Y PERMITIR VARIOS PRODS Y CONSUMI FIFO 
//3-CREAR UN ARCHIVO NUEVO VARIOS PRODS Y CONSUM LIFO	(en soluciones)
...
int ProdCons1SC::leer(  )
{
   ...
   if ( primera_libre == 0 )//Para varios while
...
void ProdCons1SC::escribir( int valor )
{
   ...
   if ( primera_libre == num_celdas_total )//Para varios while
      libres.wait( guarda );
